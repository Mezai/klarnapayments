...
<tr>
	...
	<td>{$KlarnaPClass[2]->getInterestRate()|escape:'htmlall':'UTF-8'}{$partpayment_interest_symbol|escape:'htmlall':'UTF-8'}</td>

</tr>

<tr>
	<td>{l s='Effective interest rate' mod='klarnapayments'}</td>
	<td>{$klarna_calc_apr2|escape:'htmlall':'UTF-8'}{$partpayment_interest_symbol|escape:'htmlall':'UTF-8'}</td>

</tr>

<tr>
	<td>{$partpayment_startfee_label|escape:'htmlall':'UTF-8'}</td>
	<td>{$KlarnaPClass[2]->getStartFee()|escape:'htmlall':'UTF-8'}{$partpayment_invoicefee_symbol|escape:'htmlall':'UTF-8'}</td>

</tr>

<tr>
	<td>{$partpayment_invoicefee_label|escape:'htmlall':'UTF-8'}</td>
	<td>{$KlarnaPClass[2]->getInvoiceFee()}{$partpayment_invoicefee_symbol|escape:'htmlall':'UTF-8'}{l s='/month'
...
<tr>
	...
	<td>{$klarna_calc_monthly2|escape:'htmlall':'UTF-8'}{$partpayment_invoicefee_symbol|escape:'htmlall':'UTF-8'}{l s='/month'
		mod='klarnapayments'}</td>
...
<tr>
	...
	<td>{$klarna_calc_total_credit2|escape:'htmlall':'UTF-8'}{$partpayment_invoicefee_symbol|escape:'htmlall':'UTF-8'}</td>
...
<tr>
	...
	<td>{displayPrice price=$klarna_calc_monthly2}</td>
</tr>
<tr>
	<td>{$partpayment_interest_label|escape:'htmlall':'UTF-8'}</td>
...
{/if}
{if $klarna_locale == 'FI'}
<h4>{displayPrice price=$klarna_calc_monthly2}{l s='/kk' mod='klarnapayments'}{$KlarnaPClass[2]->getDescription()|escape:'htmlall':'UTF-8'}</h4>
<table class="table">
<tbody>
	<tr>
		<td>Vousikorko</td>
	...
	<tr>
		<td>Alouitusmaksu</td>
		<td>{displayPrice price=$KlarnaPClass[2]->getStartFee()}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>{$klarna_calc_monthly2|escape:'htmlall':'UTF-8'}{l s='€/kk' mod='klarnapayments'}</td>
	</tr>
	<tr>
