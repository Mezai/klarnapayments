...
{if $klarna_locale == 'SE'}
<h4>{displayPrice price=$klarna_calc_monthly3}{l s=' in ' mod='klarnapayments'}{$KlarnaPClass[3]->getDescription()|strip_tags:'UTF-8'}</h4>
<table class="table">
<tbody>
<tr>
...
<tr>
	...
	<td>{$KlarnaPClass[3]->getInvoiceFee()}{l s='kr/.md' mod='klarnapayments'}</td>
</tr>
<tr>
