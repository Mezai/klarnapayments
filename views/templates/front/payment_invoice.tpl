...
{capture name=path}
	<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" title="{l s='Go back to the Checkout' mod='klarnapayments'}">{l s='Checkout' mod='klarnapayments'}</a><span class="navigation-pipe">{$navigationPipe}</span>{l s='Klarna invoice' mod='klarnapayments'}
