...
<div class="container-fluid klarnainvoicepayment">
	<img id="klarna_logo" class="klarna_logo" src="https://cdn.klarna.com/1.0/shared/image/generic/logo/sv_se/basic/blue-black.png?width=200">
		...
		<div class="row margin-b-2">
				<div class="col-sm-6">
							<form action="{$validation_url|escape:htmlall:'UTF-8'}" method="post" id="klarna_form">
								<div class="required form-group">
									<label for="select_klarna_method" class="required">{l s='Select a payment method' mod='klarnapayments'}</label>
 									...
 									<div class="form-group">
 										<label for="klarna_house_extension">{l s='House extension:' mod='klarnapayments'}</label>
 										<input type="text" id="klarna_house_extension" class="validate form-control" name="klarna_house_ext">
 									</div>
 									{/if}
  									<div class="required form-group">
			...
			<div class="row margin-b-2">
				<div class="col-sm-6">
						...
						{if $klarna_country == 'FI'}<h4>Erämaksu</h4>{/if}
							<form action="{$validation_url|escape:htmlall:'UTF-8'}" method="post">
  								<div class="required form-group">
  									<label for="select_klarna_method" class="required">{l s='Select a payment method' mod='klarnapayments'}</label>
